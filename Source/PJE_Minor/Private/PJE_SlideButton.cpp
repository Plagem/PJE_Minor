...
#include "PJE_SlideButton.h"

void APJE_SlideButton::ButtonBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
...
void APJE_SlideButton::ButtonEndOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
